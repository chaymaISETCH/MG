...
public class ProduitsP extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView list;
    List<Produit> mliste;
     ...
     Button   ht = (Button) findViewById(R.id.ht);
        ht.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                a = new ProduitAdapter(ProduitsP.this, l);
