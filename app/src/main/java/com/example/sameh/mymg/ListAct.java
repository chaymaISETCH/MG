...
public class ListAct extends AppCompatActivity {
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(ListAct.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://192.168.8.105/test/t.php");
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(ListAct.this, "Something went wrong. Connection Problem."+e.getMessage(), Toast.LENGTH_LONG).show();
            ...
            try {
                ...
                for (int i = 0 ; i < data_array.length() ; i++)
                {
                  ...
                  /* produit.setLibelle(obj.getString("libelle"));
                    ...
                    listePro.add(p);
                    Intent intent = new Intent(ListAct.this,Produits.class);
