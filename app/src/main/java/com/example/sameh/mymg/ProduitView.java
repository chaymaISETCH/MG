...
public class ProduitView extends LinearLayout {

    private TextView tvNom, tvPrix,tvPrixp;
    private ImageView tvImg;

    public ProduitView(Context c, AttributeSet attrs) {
        super(c, attrs);

    }


    public static ProduitView create(ViewGroup parent) {

        LayoutInflater li = LayoutInflater.from(parent.getContext());
        ProduitView itemView = (ProduitView) li.inflate(R.layout.item, parent, false);
        itemView.findViews();
        return itemView;
